...
try {
  ...
  console.log("Firebase initialized successfully.");
    ...
    // In a real-world app, you might want to throw an error or handle this differently
    // For this context, we will allow the app to run but services will be null.
    // @ts-ignore
    app = null;
    // @ts-ignore
    auth = null;
